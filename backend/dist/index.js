...
app.post("/api/v1/todo", authentication, async (req, res) => {
    try {
...
app.get("/api/v1/todos", authentication, async (req, res) => {
...
app.put("/api/v1/todo/:id", authentication, async (req, res) => {
    try {
...
app.delete("/api/v1/todo/:id", authentication, async (req, res) => {
    try {
        const todoId = req.params.id;
